...
def corrector(text, type):
    ...
    text = text.replace(")", "")
    text = text.replace(")", "")
    text = text.replace("ɔ̄", "o")
    text = text.replace("ā", "a")
    text = text.replace("ā", "a")
    text = text.replace("ı̯", "j")
    text = text.replace("ē", "e")
    text = text.replace("χ", "x")
    text = text.replace("ŭ", "u")
    text = text.replace("è", "e")
    text = text.replace("é", "e")
    text = text.replace("ɣ͕", "ɣ")
    text = text.replace("ı̮", "i")
    text = text.replace("ū", "u")
    text = text.replace("ɒ", "a")
    text = text.replace("à", "a")
    text = text.replace("u̯", "w")
    text = text.replace("w̯̯", "w")
    text = text.replace("ń", "n'")
    text = text.replace("a:", "a")
    text = text.replace("e:", "e")
    text = text.replace("ɔ", "o")
    text = text.replace("ȯ", "o")
    text = text.replace("ō", "o")
    text = text.replace("w̯", "w")
    text = text.replace("ı̱̯", "i")
    text = text.replace("ė", "e")
